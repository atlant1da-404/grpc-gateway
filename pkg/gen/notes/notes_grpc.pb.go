// Code generated by protoc-gen-go-pkg. DO NOT EDIT.
// versions:
// - protoc-gen-go-pkg v1.2.0
// - protoc             v3.20.1
...
type NotesClient interface {
	GetNote(ctx context.Context, in *NotesRequest, opts ...grpc.CallOption) (*NotesResponse, error)
}
...
func (c *notesClient) GetNote(ctx context.Context, in *NotesRequest, opts ...grpc.CallOption) (*NotesResponse, error) {
...
type NotesServer interface {
	GetNote(context.Context, *NotesRequest) (*NotesResponse, error)
...
func (UnimplementedNotesServer) GetNote(context.Context, *NotesRequest) (*NotesResponse, error) {
...
func _Notes_GetNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServer).GetNote(ctx, req.(*NotesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// Notes_ServiceDesc is the grpc.ServiceDesc for Notes service.
// It's only intended for direct use with pkg.RegisterService,
